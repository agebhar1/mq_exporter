...
FROM registry.access.redhat.com/ubi8/ubi-minimal:8.7-1085.1679482090 AS builder
...
LABEL \
    ...
    org.opencontainers.image.base.name="registry.access.redhat.com/ubi8/ubi-minimal:8.7-1085.1679482090"
