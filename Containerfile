...
FROM registry.access.redhat.com/ubi8/ubi-minimal:8.10-1780550539 AS builder
...
LABEL \
    ...
    org.opencontainers.image.base.name="registry.access.redhat.com/ubi8/ubi-minimal:8.10-1780550539"
