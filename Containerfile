...
FROM registry.access.redhat.com/ubi8/ubi-minimal:8.9-1108.1706691034 AS builder
...
LABEL \
    ...
    org.opencontainers.image.base.name="registry.access.redhat.com/ubi8/ubi-minimal:8.9-1108.1706691034"
