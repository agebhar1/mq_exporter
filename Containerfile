# Copyright 2021-2025 Andreas Gebhardt
#
...
FROM registry.access.redhat.com/ubi8/ubi-minimal:8.10-1295.1749680713 AS builder
...
RUN microdnf install tar gzip findutils gcc make git \
    ...
    && curl -L https://go.dev/dl/go1.25.0.linux-amd64.tar.gz | tar xzf - -C /opt
...
LABEL \
    ...
    org.opencontainers.image.base.name="registry.access.redhat.com/ubi8/ubi-minimal:8.10-1295.1749680713"
